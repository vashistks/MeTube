...
?>
<h3><?php echo $fname;?>, you can edit email here </h3>
<form action="editemail.php" method="post">
	<table>
	<tr height="75">
	<td>Email ID: </td><td height="75"><input type="email" class="form-control" name="newemail"></td></tr>
...
if(isset($_POST['submit'])) 
{
		...
		{
		$check = update_email($_POST['newemail']);	
		if($check == 1)
		{
		...
		{
			echo "Email already exists. Please user a different Email ID.";
		}
		}
	}
