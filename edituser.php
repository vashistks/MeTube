...
<li>
	...
	<input type="text" class="form-control" placeholder="Search for..." name="searchtext"> 
             <span class="input-group-btn"> <button class="btn btn-default" type="button" name="search">Search</button> </span>				
		</div>
	 </form>
<?php
...
?>
<h3><?php echo $fname;?>, you can edit username here</h3>
<form action="edituser.php" method="post">
	<table>
	<tr>
	<td height="75">
	Username: </td><td height="75"><input type="text" class="form-control" name="newusername"></td> </tr>
	<tr><td><a href="updateprofile.php"  class="btn btn-default">Cancel</a></td>
	<td><input name="submit" class="btn btn-default" type="submit" value="Update"></td></tr>
	</table>
</form>
...
if(isset($_POST['submit'])) 
{
		...
		{
		$check = update_username($_POST['newusername']);	
		if($check == 1)
		{
