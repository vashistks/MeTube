...
<form action="editpwd.php" method="post">
	...
	<tr>
	<td height="50">
	Current Password:</td><td height="50"> <input type="password" class="form-control" name="password"></td></tr>
	<tr><td height="50">New Password: </td><td height="50"><input type="password" class="form-control" name="newpassword1"></td></tr>
	<tr><td height="50">Repeat New Password: </td><td height="50"><input type="text" class="form-control" name="newpassword2" </td></tr>
...
if(isset($_POST['submit'])) 
{
		...
		else if(empty($_POST['newpassword1']))
		{
			echo "Blank field";
		}
		...
		{
		$curr_pwd_check = check_currpwd($_POST['password']);
		if($curr_pwd_check==1)
		{
			$new_pwd_check = check_newpwd($_POST['newpassword1'],$_POST['newpassword2']);
			if($new_pwd_check == "1")
			{
?>
...
<?php
			...
			else if($new_pwd_check == "2")
			{
				echo "Passwords no not match";
			}
			else if($new_pwd_check == "3")
			{
				echo "New password cannot be old password";
			}
		}
		else if($curr_pwd_check == "2")
		{
